...
export function UserMenu() {
  ...
  if (!user) {
    return <div className="h-8 w-8 rounded-full bg-slate-200" aria-hidden />
  }
      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            className={cn(
              "flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1.5 outline-none text-slate-600",
