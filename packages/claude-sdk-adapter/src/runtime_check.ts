...
try {
  ...
  process.stdout.write(JSON.stringify({ type: "runtime_ready", protocol: 1, features: ["mcp_http_tools", "mcp_http_bearer_auth", "workspace_tools"], node: process.versions.node, sdk: sdk.version, mcp: mcp.version, native: nativeVersion }) + "\n");
} catch {
