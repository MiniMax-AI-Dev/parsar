...
func TestExecutionPersistsLiveAndCancelledPartialOutput(t *testing.T) {
	...
	h.write(input.TurnID, proto.TypeToolCall, proto.ToolCallPayload{ID: "tool-1", Name: "Bash", Stage: "before", Args: map[string]any{"command": "pwd"}})
	h.write(input.TurnID, proto.TypeToolCall, proto.ToolCallPayload{ID: "tool-1", Name: "Bash", Stage: "after", Result: map[string]any{"exit_code": 0}})
