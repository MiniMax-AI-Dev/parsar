...
func observeItems(ctx context.Context, s *store.Store, tenant, session, turn, status string) error {
	events := []store.ExecutionEvent{
		...
		{Kind: "tool_call", Payload: json.RawMessage(`{"id":"dynamic","stage":"after","native_item":{"id":"dynamic","type":"dynamicToolCall","tool":"lookup","namespace":"reference","arguments":{},"status":"completed","success":true,"contentItems":[{"type":"inputText","text":""}]}}`)},
