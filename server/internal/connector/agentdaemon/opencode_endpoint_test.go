...
func TestOpenCodeManagedEndpoint(t *testing.T) {
	for _, tc := range []struct {
		...
		{"chat typed alias", "@ai-sdk/openai-compatible", "", map[string]string{"chat-completions": "https://gateway.test/chat/v1/chat/completions"}, "", "https://gateway.test/chat/v1"},
		{"responses typed alias", "@ai-sdk/openai", "", map[string]string{"responses": "https://gateway.test/responses/v1/responses"}, "", "https://gateway.test/responses/v1"},
