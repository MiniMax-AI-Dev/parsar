...
assert.deepEqual(report.features, [...(process.platform === "linux" ? ["workspace_directory"] : []), "mcp_http_tools", "mcp_http_bearer_auth", "workspace_tools", "workspace_prepare", "workspace_read", "workspace_command_observations"]);
